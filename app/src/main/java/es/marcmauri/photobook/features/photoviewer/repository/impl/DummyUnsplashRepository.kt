...
class DummyUnsplashRepository : UnsplashRepository {
    ...
    private val photos: List<UnsplashPhoto> by lazy { getDummyPhotos() }

    override suspend fun getPhotosByPage(page: Int) = photos

    private fun getDummyPhotos(): List<UnsplashPhoto> {
