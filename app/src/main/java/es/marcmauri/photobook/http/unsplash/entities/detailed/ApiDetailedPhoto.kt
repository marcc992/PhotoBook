...
data class ApiDetailedPhoto(
    ...
    @SerializedName("exif") val exif: ApiDetailedExif,
    @SerializedName("location") val location: ApiDetailedLocation,
    @SerializedName("meta") val meta: ApiDetailedMeta,
    @SerializedName("public_domain") val public_domain: Boolean,
    @SerializedName("tags") val tags: List<ApiDetailedTags>,
    @SerializedName("tags_preview") val tags_preview: List<ApiDetailedTagsPreview>,
    @SerializedName("related_collections") val related_collections: ApiDetailedRelatedCollections,
